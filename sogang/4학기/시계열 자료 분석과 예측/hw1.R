data <-read.csv(file="C:/Users/tjtmd/Documents/GitHub/FinDucks.github.io/sogang/4학기/시계열 자료 분석과 예측/portfolio.csv", header=TRUE, sep=",")
# 1)
cor(data)
...
'
#유의수준이 다름
data_bodyfat <-read.csv(file="C:/Users/tjtmd/Documents/GitHub/FinDucks.github.io/sogang/4학기/시계열 자료 분석과 예측/BodyFat_hw.csv", header=TRUE, sep=",")
# 1)산포도 그리기 
data_bodyfat
...
model <- lm(data_bodyfat$Girth ~ data_bodyfat$Fat, data=data_bodyfat)
summary(model)
...
model$coefficients
plot(data_bodyfat$Girth, data_bodyfat$Fat, asp=100)
